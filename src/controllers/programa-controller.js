const service = require('../services/programa-service');
module.exports = {
    ...
    atualizar: async (req, res) => {
        ...
        if (id && programa_nome && status) {
            await service.atualizar(db_codigo, programa_nome, status);
            json.result = {
                id,
                programa_nome,
