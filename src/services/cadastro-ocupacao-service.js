...
module.exports = {
    atualizar: (id, campos) => {
        return new Promise((aceito, rejeitado) => {
            ...
            const sql = `UPDATE gta_cadastro_tipo_ocupacao_moradia SET ${colunas} WHERE id = ?`;
    ...
    inserir: (campos) => {
        return new Promise((accept, reject) => {
            ...
            const sql = `INSERT INTO gta_cadastro_tipo_ocupacao_moradia (${colunas}) VALUES (${placeholders})`;
